...
namespace BizOpsAPI.Migrations
{
    ...
    [Migration("20250822104834_FixReceiptSizeBytesCheckForPostgres")]
    partial class FixReceiptSizeBytesCheckForPostgres
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BizOpsAPI.Models.Receipt", b =>
                {
                    ...
                    b.HasIndex("InvoiceId", "Sha256Hex");

                    b.ToTable("Receipts", t =>
                        {
                            t.HasCheckConstraint("CK_Receipt_SizeBytes_NonNegative", "\"SizeBytes\" IS NULL OR \"SizeBytes\" >= 0");
                        });
                });
